...
levels(long_pointinterval$Variable) <- c("F0", "F0_sd", "F1", "F1_sd", 
                                         "F2", "F2_sd", "F3", "F3_sd", 
                                         "F4", "F4_sd","H1H2c", "H1H2c_sd",
                                         "H2H4c", "H2H4c_sd","H42Kc", "H42Kc_sd",
                                         "H2KH5Kc", "H2KH5Kc_sd","CPP", "CPP_sd",
                                         "Energy", "Energy_sd","SHR", "SHR_sd")
...
long_pointinterval %>%
  mutate(
    CohenD = as_factor(CohensD_Group),
    Variable = str_replace(Variable, '_sd', ' s.d.'),
    Variable = str_replace(Variable, 'H1H2c', 'H1*-H2*'),
    Variable = str_replace(Variable, 'H2H4c', 'H2*-H4*'),
    Variable = str_replace(Variable, 'H42Kc', 'H4*-H2kHz*'),
