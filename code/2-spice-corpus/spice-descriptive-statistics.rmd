...
ggsave('../../text/figures/ch2_wordfrequency_6in.png', width = 6, height = 3)
```
...
ggsave('../../text/figures/ch2_wordfrequency_4in.png', width = 4, height = 3)
```
...
demographics %>%
    ...
    ggplot(aes(y=fct_rev(Place))) +
        geom_bar() +
        facet_wrap(~Ages, ncol=4) +
        ylab('Country Lived In') +
        xlab('Count') +
        theme(legend.position = 'none')

ggsave('../../text/figures/ch2_placeslived_7in.png', width = 7, height = 3)
```
...
ggsave('../../text/figures/ch2_caretakers_4in.png', width = 4, height = 4)
...
tidy_languages %>%
    ...
    ggplot(aes(y=Age, x='', color = Age, label=Language)) +
        geom_point(size=1.5, shape=18, alpha=0.75) +
        geom_text_repel(max.iter=100000, min.segment.length = 0,
                        box.padding = 0.35, force=2, size=2, max.overlaps = 10) +
...
# ggsave('../../text/figures/ch2_multilingualism_7.png', width = 7, height = 9)
```
