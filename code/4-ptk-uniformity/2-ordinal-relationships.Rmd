...
# ggsave('ptk_vot_individuals.png', height = 3, width = 8, units='in') # Used in interspeech paper with manually moved legend - don't re-run; different sizes for paper and poster
```
