...
```{r}
df <- read_csv('ptk_clean_20210331.csv') # this version used in Interspeech paper
head(df)
```
...
**Writing out for easier reference and copying**
...
ggsave('correlation_uniformity.png', plot=all, height = 10, width = 12, units='in') #used in ISBPAC poster
```
