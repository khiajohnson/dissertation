...
\begin{table}[!htbp]
  ...
  \begin{tabular}{L{0.9in}L{0.75in}L{0.45in}L{0.8in}L{0.5in}L{0.5in}} %p{1cm}|p{3cm}
    ...
    \midrule
    Bangor Miami \citep{deuchar_2014_corpora} & 63\% English\newline 34\% Spanish & \hl{CHECK} & Conversational, code-switching & Yes, most talkers & \hl{CHECK} \\
    \midrule
    ...
    \midrule
    Bangor Siarad \citep{deuchar_2014_corpora} & 84\% Welsh\newline 4\% English & \hl{CHECK} & Conversational, code-switching & \hl{CHECK} & \hl{CHECK} \\
    \midrule
    \hl{add more here!}  & & & & \\
    & & & & \\
    & & & & \\
