...
% summarize chapter in a paragraph

% describe results, connecting with prior work

% consequences for perception
% "That listeners appear to use these measures is of direct relevance to the study presented in this chapter, and represents a point that will be returned to in this chapter's discussion.""

% connections to face processing
% % cite that cool oxford face variability study in the discussion

% limitations

% describe take-home points and why it matters
