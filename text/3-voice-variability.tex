...
% Related language findings
\hl{While the body of work in this area on Cantonese-English bilinguals remains small, there are useful insights from other language pairs.} 

% \citep{lee_2017_bilingual} Mandarin

% \citep{keating_2012_f0} Mandarin

% \citep{xue_2002_f0} Mandarin

% \citep{cheng_2020_f0} Korean

% \citep{ryabov_2016_self} Russian

% \citep{mennen_2012_f0} German

% Tying it all together in the bigger picture
Not all factors are necessarily easy to separate as linguistic or talker-instrinsic. For example... \hl{Speech rate shared across languages, for example} % BRadlow paper
