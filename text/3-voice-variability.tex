...
\hl{Summarize Baumann and Belin, 2010 paper} \citep{baumann_2008_scaling}.

\hl{Section on LFE here --- write during friday writing time}
% NOT SURE WHERE TO PUT THIS CHUNK %%
That bilingual listeners are sensitive to this information signals its importance \citep{orena_2019_identifying,fricke_2016_phonetic}. The following paragraphs summarize this work. Voice advantage \citep{levi_2018_advantage}. Talker change detection \citep{sharma_2020_acoustic}
\hl{Talker identification generalizes, but not amazingly well} % work on this during writing time friday
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\hl{Cite Perrachione JASA paper somewhere in here} \citep{perrachione_2019_acoustic}.
