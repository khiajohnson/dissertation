...
\label{ch3:fig:VF32A}
\end{center}
\end{figure} % too large of image but figure out later
...
While this covers a lot of the variables included in the PCAs, F0 is notably sparse in the above paragraphs. This is because F0 patterned very inconsistently. %often co-occurred with Energy
