...
\begin{table}[htbp]
    ...
    \begin{tabular}{ccc}
    \toprule
    \textbf{Dimension} & \textbf{Category} & \textbf{Percept} \\
    \midrule
    F0 & F0 & pitch \\
    \bottomrule
    \end{tabular}
